      ...
      <v-container fluid class="card_validated">
        <v-row class="justify-center fill-height">
          ...
          <template v-if="!successChange">
            <v-col cols="12" sm="9">
              ...
              <div class="d-flex flex-column flex-sm-row justify-space-between">
                <label style="width: 40%;" for="password-new"
                  >Ingresa tu Contraseña Nuevamente:</label
                >
                <div style="width: 50%;">
                  <v-text-field
                    id="password-new"
            ...
            <v-col cols="12" sm="3">
              <span class="text-caption">
                La contraseña debe contener como mínimo: 8 caracteres, 1 letra,
                1 número y un carácter especial (tal como . - ,)
              </span>
            </v-col>
            <v-col cols="12">
          ...
          <v-col v-else cols="12">
            <span>revise su email, se le envio la activación de su cuenta</span>
          </v-col>
        </v-row>
      </v-container>
    </div>
